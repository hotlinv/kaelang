...
将图片《图像1》另存为：磁颐国输目省图像数据输出市图像1单元jpg间。
```
...
比如可以这样打开图片：
```
打开在磁颐国工根省测试数据市lena单元png间的图像文件“第一夫人”。
```
这样显示图片
```
展示图像《第一夫人》。
...
然后保存
```
将图片《第一夫人》另存为：磁颐国输目省图像市第一夫人单元jpg间。
```
也可以新建一张图片
```
...
将图片《图像1》另存为：磁颐国输目省图像市图像1单元jpg间。
```
